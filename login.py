...
def login():
    ...
    elif usernameEntry.get()=='Arghyanil' and passwordEntry.get()=='1234':
...
usernameEntry=CTkEntry(root,placeholder_text='Enter Your Username',width=180,fg_color='#FAFAFA',text_color='black')
usernameEntry.place(x=50,y=150)

passwordEntry=CTkEntry(root,placeholder_text='Enter Your Password',width=180,fg_color='#FAFAFA',text_color='black',show='*')
